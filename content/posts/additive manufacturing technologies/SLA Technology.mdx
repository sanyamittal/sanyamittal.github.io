...
Form Cure is designed to post-cure resin 3D printed parts printed with speed and consistency.
...
+ Lower cost
+ Widely available
+ Lesser material wasted
+ Very large build size
+ Faster build times
Disadvantages
- Small build size
- Smaller material range
- Requires more post-processing due to extensive use of support
- Higher cost
- Requires specialist operator
- Changing material involves emptying the whole tank
Popular SLA printer manufacturers
Formlabs
3D Systems
Build size
Up to 145 x 145 x 175mm
...
Flexible resin
+ Rubber-like material- Lower dimensional accuracy
